...
$(document).ready(function () {
    ...
    function make(url, name, date, dir) {
        ...
        if (name == "..") {
            html += "                    <tr>\n";
            html += "                      <td colspan=\"3\" class=\"file-name\" item-type= \"dir\" data-name=\"\"><a href=\"javascript:void(0);\" class=\"load-path\">";
            html += ""
            html += name + "/";
            html += "</a></td>\n";
            html += "                    </tr>\n";
            ...
            html += "                    <tr>\n";
            html += "                      <td class=\"file-name\" item-type= \"" + (dir ? "dir" : "file") + "\" data-name=\"" + url + (url.substring(url.length - 1) != "/" ? "/" : "") + name + "\">";
            if (dir) {
